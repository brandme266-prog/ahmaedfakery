...
const blogs = ['marble-granite-machines-egypt-fekry-group', 'overhead-cranes-marble-factories', 'marble-machine-prices-egypt-guide', 'ahmed-fekry-industrial-pioneer', 'marble-machines-maintenance-guide', 'shaq-el-thoban-oil-bath-saw-preference', 'who-is-ahmed-fekry', 'قصة-نجاح-المهندس-احمد-فكري'];
