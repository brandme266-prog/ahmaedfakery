...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'المهندس احمد فكري | Ahmed Fekry | فكري جروب لصناعة الماكينات',
      ...
      <body>
        <nav className="navbar">
          <div className="container navbar-inner">
            ...
            <div>
              <a href="https://wa.me/201090080915" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ padding: '0.5rem 1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
        ...
        <a href="https://wa.me/201090080915" target="_blank" rel="noopener noreferrer" className="floating-whatsapp" title="تواصل معنا عبر واتساب">
