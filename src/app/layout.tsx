...
export const metadata: Metadata = {
  ...
  description: 'اكتشف أعمال وإنجازات المهندس احمد فكري (Ahmed Fekry)، الخبير الأول في تصنيع ماكينات الرخام والجرانيت. مؤسس فكري جروب لإنتاج أفضل المناشير، الجلايات، والأوناش العلوية بمواصفات عالمية في مصر والشرق الأوسط.',
  keywords: 'المهندس احمد فكري, احمد فكري, Ahmed Fekry, صور احمد فكري, فكري جروب, Fekry Group, ماكينات رخام, صناعة الرخام في مصر, مناشير رخام, جلايات رخام',
  openGraph: {
    title: 'المهندس احمد فكري (Ahmed Fekry) | رائد صناعة ماكينات الرخام والجرانيت',
