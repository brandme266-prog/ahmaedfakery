...
export const metadata: Metadata = {
  ...
  description: 'المهندس احمد فكري، رائد صناعة ماكينات الرخام والجرانيت في مصر والشرق الأوسط. نوفر أحدث المناشير، جلايات الرخام، والأوناش العلوية بأفضل الأسعار.',
