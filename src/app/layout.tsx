...
export const metadata: Metadata = {
  title: ' احمد فكري (Ahmed Fekry) | رائد صناعة ماكينات الرخام والجرانيت',
  description: 'اكتشف أعمال وإنجازات  احمد فكري (Ahmed Fekry)، الخبير الأول في تصنيع ماكينات الرخام والجرانيت. مؤسس فكري جروب لإنتاج أفضل المناشير، الجلايات، والأوناش العلوية بمواصفات عالمية في مصر والشرق الأوسط.',
  keywords: 'احمد فكري,  احمد فكري, Ahmed Fekry, صور احمد فكري, فكري جروب, Fekry Group, ماكينات رخام, صناعة الرخام في مصر, مناشير رخام, جلايات رخام',
  openGraph: {
    title: ' احمد فكري (Ahmed Fekry) | رائد صناعة ماكينات الرخام والجرانيت',
    description: 'اكتشف أعمال وإنجازات احمد فكري (Ahmed Fekry)، الخبير الأول في تصنيع ماكينات الرخام والجرانيت في مصر. مؤسس فكري جروب.',
    locale: 'ar_EG',
    type: 'website',
  },
  icons: {
