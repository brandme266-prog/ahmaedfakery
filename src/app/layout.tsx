...
export const metadata: Metadata = {
  title: 'Ahmed Fekry | المهندس احمد فكري - رائد صناعات مكن الرخام في مصر و الشرق الأوسط',
  description: 'Ahmed Fekry (المهندس احمد فكري) - رائد صناعة ماكينات الرخام والجرانيت في مصر والشرق الأوسط. مؤسس فكري جروب للمناشير وجلايات الرخام والأوناش العلوية بأفضل الأسعار.',
  ...
  openGraph: {
    title: 'Ahmed Fekry | المهندس احمد فكري - رائد صناعات مكن الرخام في مصر و الشرق الأوسط',
    description: 'Ahmed Fekry (المهندس احمد فكري) - رائد صناعة ماكينات الرخام والجرانيت في مصر. مؤسس فكري جروب للمناشير وجلايات الرخام والأوناش العلوية.',
    locale: 'ar_EG',
    type: 'website',
  },
  icons: {
