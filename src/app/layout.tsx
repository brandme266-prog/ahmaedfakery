...
export const metadata: Metadata = {
  title: 'المهندس احمد فكري | Ahmed Fekry - رائد صناعات مكن الرخام في مصر و الشرق الأوسط',
  description: 'المهندس احمد فكري، رائد صناعة ماكينات الرخام والجرانيت في مصر والشرق الأوسط. نوفر أحدث المناشير، جلايات الرخام، والأوناش العلوية بأفضل الأسعار. Ahmed Fekry',
